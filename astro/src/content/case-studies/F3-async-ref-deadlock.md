...
tags: ["case-study", "async", "RwLock", "deadlock", "DPOR"]
cover:
...
The DPOR tree is short because only one branch matters: does the writer block the thread before or after the reader drops the guard?
