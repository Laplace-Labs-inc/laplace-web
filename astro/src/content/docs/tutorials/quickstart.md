...
```bash
# 저장소 클론 및 CLI 설치
git clone https://github.com/Laplace-Labs-inc/laplace-dev.git
cd laplace-dev
...
이제 준비가 끝났습니다. 아래 명령어를 통해 Laplace 커널을 가동합니다.
...
- 더 깊은 이해: [Sovereign Architecture](/docs/concepts/architecture/)
- 엔진별 상세: [Axiom](/docs/concepts/axiom/) / [Kraken](/docs/concepts/kraken/) / [Probe](/docs/concepts/probe/)
- 실제 사례: [Case Studies](/blog/case-studies/)
