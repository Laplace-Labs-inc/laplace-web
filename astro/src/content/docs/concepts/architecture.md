...
자세한 설명: [Axiom — DPOR+POR Verification](/docs/concepts/axiom/)
...
자세한 설명: [Kraken — Load Engine](/docs/concepts/kraken/)
...
자세한 설명: [Probe — Observation Mesh](/docs/concepts/probe/)

---

## 중앙 통제 (Global Configuration)

이 거대한 3개의 엔진은 파편화되어 있지 않습니다. Laplace는 쿠버네티스의 철학을 계승하여 `laplace.toml`이라는 단 하나의 **Single Source of Truth**로 통제됩니다. 또한, 실행 중인 서버를 멈추지 않고 설정을 변경할 수 있는 **RCU(Read-Copy-Update) 기반 무중단 핫리로딩**을 지원합니다.

직접 체험: [빠른 시작 (Quickstart)](/docs/tutorials/quickstart/)
