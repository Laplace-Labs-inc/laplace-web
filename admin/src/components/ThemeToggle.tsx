...
/** Light ⇄ dark toggle. Shares the `laplace-theme` localStorage key and the
 *  `data-theme` <html> attribute with the pre-paint snippet in index.html, so
 *  there is no flash and the choice persists across all Laplace subdomains. */
